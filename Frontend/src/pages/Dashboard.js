...
function Dashboard() {
  ...
  const fetchTotalSaleAmount = async () => {
    try {
      const response = await fetch(
        `${config.apiUrl}/sales/get/${authContext.user}/totalsaleamount?period=${timePeriod}`
      );
  ...
  const fetchTotalPurchaseAmount = async () => {
    try {
      const response = await fetch(
        `${config.apiUrl}/purchase/get/${authContext.user}/totalpurchaseamount?period=${timePeriod}`
      );
      const data = await response.json();
      if (response.ok) {
  ...
  const fetchStoresData = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/store/get/${authContext.user}`);
      const data = await response.json();
      if (response.ok) {
        setStores(data);
      } else {
  ...
  const fetchMonthlySalesData = async () => {
    try {
      const response = await fetch(`${config.apiUrl}/sales/getmonthly`);
      const data = await response.json();
      if (response.ok) {
