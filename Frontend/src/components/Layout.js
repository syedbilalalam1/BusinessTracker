    ...
    <>
      ...
      <div className="grid grid-cols-12 bg-gray-100 items-baseline min-h-screen relative">
        ...
        <div className="col-span-12 bg-gray-800 text-white py-3 text-center text-sm fixed bottom-0 w-full">
          <p>© {new Date().getFullYear()} - Created by <a href="https://github.com/syedbilalalam1" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300">Syed Bilal Alam</a></p>
        </div>
      </div>
    </>
  );
