...
const navigation = [
  ...
  { name: "Stock Management", href: "/stock-management", current: false },
  ...
  { name: "Shipment Tracker", href: "/shipment-tracker", current: false },
];
                    ...
                    <Link to={item.href} key={item.name}>
                      <Disclosure.Button
                        ...
                        className={classNames(
                          ...
                          "block rounded-md px-3 py-2.5 text-base font-medium w-full text-left"
                        )}
